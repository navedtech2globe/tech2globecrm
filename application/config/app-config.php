...
*
*/
define('APP_BASE_URL', 'https://buynfill.in/CRM/');
...
*/
define('APP_ENC_KEY', '58c7f8ebe14ee4864d243a6a65459dd6');
 ...
 */
define('APP_DB_USERNAME', 'buynfqw4_crm_t2g');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '+{P4zUxe6=qU');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'buynfqw4_crmnew');
